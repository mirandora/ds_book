...
class Worker{
  ...
  void talk(){    
    ...
    //自分を中心に席が存在するかチェックしてもし存在するなら各種会話量計算        
    ...
    //ルール2：周りの会話量が閾値以上になると会話終了（会話量減少）
